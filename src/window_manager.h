...
struct window *window_manager_find_managed_window_above(struct window_manager *wm, struct window *window);
struct window *window_manager_find_managed_window_below(struct window_manager *wm, struct window *window);
